...
try:
    from PygameShader.shader import wave, wave_static
except ImportError:
...
array_cp = pygame.surfarray.pixels3d(BACKGROUND)
...
while GAME:
    ...
    wave_static(image, array_cp, 0.001 * math.pi / 180.0 + FRAME / 10, 10)
