...
try:
    from PygameShader.shader import hsv_effect
except ImportError:
...
while STOP_GAME:
    ...
    pygame.display.set_caption(
        "Test hsv %s fps, value %s (%sx%s)" %
        (round(clock.get_fps(), 2), round(hsv, 2), width, height))
