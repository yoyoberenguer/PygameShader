...
import PygameShader
from PygameShader.misc import scroll24, scroll24_inplace
...
try:
    BACKGROUND = pygame.image.load("../Assets/space1.jpg").convert()
...
while GAME:
    ...
    # scroll24_inplace(SCREEN, v.x, v.y)
    BACKGROUND = scroll24(BACKGROUND, v.x, v.y)
    SCREEN.blit(BACKGROUND, (0, 0))
    SCREEN.blit(FILM, (0, 0))  # , special_flags=pygame.BLEND_RGB_ADD)
    v += dv
    if v.x > 10 or v.x < -10:
        dv.x *= -1
